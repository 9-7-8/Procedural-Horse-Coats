...
class GeneCodeDisplayTest {
    ...
    void extensionAndAgoutiAlwaysLeadAndRunTogether() {
        ...
        assertEquals("Eeaa", shortForm("E/e-a/a-w/w-t/t-c/c-spl/spl-g/g-N/N-N/N-n/n-n/n" + T));
        assertEquals("eeAa", shortForm("e/e-A/a-w/w-t/t-c/c-spl/spl-g/g-N/N-N/N-n/n-n/n" + T));
    }

    @Test
    void onlyGenesWithAVariantAlleleAreListed_spaceSeparated() {
        assertEquals("EeAa nSpl", shortForm("E/e-A/a-w/w-t/t-c/c-Spl/spl-g/g-N/N-N/N-n/n-n/n" + T));
    }

    @Test
    void absenceGenesUseLowercaseNWhenHeterozygousAndTheTokenDoubledWhenHomozygous() {
        assertEquals("eeaa CrCr", shortForm("e/e-a/a-w/w-t/t-c/c-spl/spl-g/g-Cr/Cr-N/N-n/n-n/n" + T));
        assertEquals("EEaa nCr", shortForm("E/E-a/a-w/w-t/t-c/c-spl/spl-g/g-Cr/N-N/N-n/n-n/n" + T));
        assertEquals("EEaa prlprl", shortForm("E/E-a/a-w/w-t/t-c/c-spl/spl-g/g-N/N-prl/prl-n/n-n/n" + T));
        assertEquals("EEaa nprl", shortForm("E/E-a/a-w/w-t/t-c/c-spl/spl-g/g-N/N-N/prl-n/n-n/n" + T));
    }

    @Test
    void whiteGreyTestPrintBothRealTokensDominantFirst() {
        assertEquals("EEaa Ww", shortForm("E/E-a/a-W/w-t/t-c/c-spl/spl-g/g-N/N-N/N-n/n-n/n" + T));
        assertEquals("EEaa Gg", shortForm("E/E-a/a-w/w-t/t-c/c-spl/spl-G/g-N/N-N/N-n/n-n/n" + T));
        assertEquals("EEaa Tt", shortForm("E/E-a/a-w/w-T/t-c/c-spl/spl-g/g-N/N-N/N-n/n-n/n" + T));
    }
    ...
    void everythingAtOnceUsesTheDisplayOrder() {
        ...
        assertEquals("EeAa nSpl Ww nCh nCr nprl Gg Tt",
                shortForm("E/e-A/a-W/w-T/t-Ch/c-Spl/spl-G/g-Cr/N-N/prl-n/n-n/n" + T));
    }

    @Test
    void theExampleFromTheDocComment() {
        assertEquals("EeAa nSpl nCh CrCr",
                shortForm("E/e-A/a-w/w-t/t-Ch/c-Spl/spl-g/g-Cr/Cr-N/N-n/n-n/n" + T));
    }

    @Test
    void stringOverloadParsesAValidCode() {
        assertEquals("EeAa nSpl", GeneCodeDisplay.shortForm("E/e-A/a-w/w-t/t-c/c-Spl/spl-g/g-N/N-N/N-n/n-n/n" + T));
    }
