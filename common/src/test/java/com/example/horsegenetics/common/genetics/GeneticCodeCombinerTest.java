...
class GeneticCodeCombinerTest {
    ...
    void homozygousDominantCrossHomozygousRecessiveIsHeterozygous() {
        String dad = LegacyCode.keyed("E/E-A/A-N/N-t/t-c/c-N/N-N/N-N/N-n/n-n/n" + T);
        String mom = LegacyCode.keyed("e/e-a/a-N/N-t/t-c/c-N/N-N/N-N/N-n/n-n/n" + T);
        String child = GeneticCodeCombiner.combine(dad, mom, allFirst());
        assertEquals(
                Genotype.parse(LegacyCode.keyed("E/e-A/a-N/N-t/t-c/c-N/N-N/N-N/N-n/n-n/n" + T)),
    ...
    void everyGeneSegregates() {
        String a = LegacyCode.keyed("E/e-A/a-W22/N-T/t-Ch/c-SW1/N-G3/N-Cr/prl-n/n-n/n" + T);
