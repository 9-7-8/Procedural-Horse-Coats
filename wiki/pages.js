    ...
    SECTIONS: [
        {
            ...
            items: [
                ...
                { href: "fertility.html", text: "Fertility & gestation", kind: "core", views: ["gameplay","coding","science"] },
        ...
        },
        {
            ...
            items: [
                ...
                { href: "ai-setup.html", text: "AI helpers", kind: "tool", views: ["gameplay","coding"] },
        ...
        /* Subjects that exist only as a plan. Each carries a Roadmap tab and
           nothing else, which is what puts it on roadmap.html - the index is
           baked from these tabs, so a page is listed there by existing here and
           having one.

           They live in their own section rather than among the built pages on
           ...
           config.html (the options, nowhere yet). */
        {
            title: "Planned",
            items: [
                { href: "phenotype-naming.html", text: "Base-aware phenotype naming", kind: "natural", views: ["coding"] },
        ...
        },
        {
            ...
            items: [
                ...
                { href: "gene-blight.html", text: "Blight", kind: "magical", views: ["gameplay","coding"] },
        ...
        },
        {
            ...
            items: [
                { href: "gene-aggression.html", text: "Aggression", kind: "magical", views: ["gameplay","coding","science"] },
                ...
                { href: "gene-passification.html", text: "Passification", kind: "magical", views: ["gameplay","coding","science"] },
                { href: "gene-skittish.html", text: "Skittishness", kind: "magical", views: ["gameplay","coding","science"] },
        ...
        },
        {
            ...
            items: [
                ...
                { href: "gene-endless-knot.html", text: "Endless Knot", kind: "magical", views: ["gameplay","coding"] },
                ...
                { href: "gene-paisley-spill.html", text: "Paisley Spill", kind: "magical", views: ["gameplay","coding"] },
                ...
                { href: "gene-smoke-scroll.html", text: "Smoke Scroll", kind: "magical", views: ["gameplay","coding"] },
