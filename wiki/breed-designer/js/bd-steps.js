...
(function (HG) {
  ...
  bd.steps = [
    ...
    geneStep("habits", "Day & night habits",
      "What the breed does at different times of day - hunting or fleeing after dark or in daylight, stalking whoever is nearest, shifting shape at night, burning in the sun. Tick none and it is an ordinary horse around the clock.",
      function () { return bd.present(bd.HABIT_KEYS); }),
    geneStep("fighting", "Fighting & defence",
      "How the breed behaves in a fight - whether it goes for monsters, guards its rider, drives mobs away or leads them, and how hard it hits.",
      function () { return bd.present(bd.FIGHT_KEYS); }),
