...
Object.assign(lang, {
  ...
  [`item.${NS}.cart.draught`]: 'An ordinary horse keeps %s%% of its speed',
  ...
  [`item.${NS}.wagon.tooltip1`]: 'Seats four; add chests for storage and five carpets for a roof',
  ...
  [`item.${NS}.supply_cart.tooltip2`]: 'One seat, and it can fly a banner',
  [`item.${NS}.animal_cart.tooltip1`]: 'Two seats for players or animals, and it can fly a banner',
  [`item.${NS}.animal_cart.tooltip2`]: 'Small animals will climb in by themselves',
