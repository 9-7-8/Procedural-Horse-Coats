 ...
 *
 * <h2>Why they need it</h2>
 * Because they have nowhere to go. A villager survives the night by walking into a
 ...
 * they are an {@code AbstractVillager}, the same base as a wandering trader, chosen
 * precisely so that no schedule drags them away from their horses. A wandering
 * trader does not go indoors either.
 *
 * <p>Giving them one was tried at length and is what the whole barn-shelter
 ...
 * health ({@link Cowboy#HEALTH}), and nothing hunting them.
 *
 * <h2>How</h2>
 ...
 * {@link Enemy} is about to pick them and they are simply never anybody's target,
 * so nothing paths to them and nothing swings at them.
 *
 ...
 * them, or wolves, or anything defending itself.
 *
 * <p><b>Their horses are not covered.</b> They are ordinary animals and a wolf
