...
public class CartTargetingUtil {

    @Nullable
    public static  <T extends Entity> T getNearestEntity(List<? extends T> list, CartTargetingUtil.Conditions<T> targetingConditions, @Nullable Entity entity, double d, double e, double f) {
        double g = -1.0;
