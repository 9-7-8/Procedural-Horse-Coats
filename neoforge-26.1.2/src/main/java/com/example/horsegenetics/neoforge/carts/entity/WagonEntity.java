...
public class WagonEntity extends AbstractDrawnInventoryEntity {
    ...
    public Identifier getRoofTexture() {
        ...
        return Identifier.fromNamespaceAndPath(HorseCarts.MOD_ID, "textures/entity/wagon_roof_" + name + ".png");
    }
    ...
    public Item getCartItem() {
        return HorseCarts.item(CartKind.WAGON, getWoodType());
    }
    ...
    @Override
    public @NotNull InteractionResult interact(@NotNull Player player, @NotNull InteractionHand interactionHand, @NotNull Vec3 vec3) {
    ...
    public CartsConfig.CartConfig getConfig() {
        return CartsConfig.get().of(CartKind.WAGON);
    }
    ...
    protected AbstractContainerMenu createMenuLootUnpacked(int i, Inventory inventory, Player player) {
        var type = switch (this.getChestCount()) {
            case 1 -> HorseCarts.WAGON_9x4_MENU_TYPE;
            case 2 -> HorseCarts.WAGON_9x8_MENU_TYPE;
            case 3 -> HorseCarts.WAGON_12x9_MENU_TYPE;
            default -> null;
        };
