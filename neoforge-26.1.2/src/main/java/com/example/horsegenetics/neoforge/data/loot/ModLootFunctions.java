 ...
 * vanilla {@code dyed_color} component, so "a red saddle" costs one trade file
 * rather than sixteen items - and depends on no other mod, because the component
 * it writes is vanilla's.
 *
