 ...
 */
package com.example.horsegenetics.neoforge.carts.container;
...
public class SeedDrillMenu extends AbstractContainerMenu {
    ...
    public SeedDrillMenu(int i, Inventory inv, Container container) {
        this(HorseCarts.SEED_DRILL_MENU_TYPE, i, inv, container);
    }
        ...
        for (int i = 0; i < SLOT_COUNT; i++) {
            this.addSlot(new Slot(container, i, 8 + 18 * i, 28) {
                ...
                public boolean mayPlace(@NotNull ItemStack itemStack) {
                    return itemStack.is(HorseCarts.SEED_DRILL_PLANTABLE)
